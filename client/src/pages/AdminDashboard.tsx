...
export default function AdminDashboard() {
  ...
  const filteredInquiries = useMemo(() => filterInquiries(inquiries, { query, status, service, district: district === "all" ? "" : district }), [inquiries, query, status, service, district]);
