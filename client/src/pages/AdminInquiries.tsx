...
export default function AdminInquiries() {
  ...
  const filtered = useMemo(() => filterInquiries(items, { query, status, service, district: district === "all" ? "" : district }), [items, query, status, service, district]);
