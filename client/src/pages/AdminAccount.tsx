...
import { ArrowLeft, AtSign, CalendarClock, CheckCircle2, Languages, LogOut, Mail, Phone, Save, ShieldCheck, UserRound } from "lucide-react";
...
export default function AdminAccount() {
  ...
  return <main className="admin-page admin-page--redesigned admin-account-page">
