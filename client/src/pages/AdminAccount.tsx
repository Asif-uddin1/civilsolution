...
export default function AdminAccount() {
  ...
  return <main className="admin-page admin-account-page">
    ...
    <div className="admin-toolbar admin-toolbar--redesigned"><div className="admin-page-links"><Link className="text-link" to="/admin"><ArrowLeft size={16} /> {isBn ? "ড্যাশবোর্ড" : "Dashboard"}</Link><Link className="text-link" to="/admin/inquiries">{isBn ? "ইনকোয়ারি" : "Inquiries"}</Link><Link className="text-link" to="/admin/blog">{isBn ? "ব্লগ" : "Blog"}</Link></div><span><ShieldCheck size={13} /> {isBn ? "অ্যাডমিন অ্যাকাউন্ট" : "Admin account"}</span></div>
